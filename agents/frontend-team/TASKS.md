# Frontend Team Task Queue (Phase 1 MVP)
...
- [ ] `FE-105`: Build Chart of Accounts UI (Tree/List view, Create/Edit Account modal)
- [ ] `FE-106`: Build Journal Entry Creation UI (Double-entry debit/credit ledger builder)
- [ ] `FE-107`: Build Ledger Account & Transaction History View UI
- [ ] `FE-108`: Build Financial Reports Dashboard (Trial Balance, P&L, Balance Sheet views)
